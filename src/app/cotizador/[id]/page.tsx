...
const DynamicViewQuotationPage = dynamic(() => Promise.resolve(() => {
  type Quotation = {
  ...
  return <ViewQuotationPageContent />;
}), { ssr: false, loading: () => <div className="container mx-auto py-10">Cargando página...</div> });

export default function ViewQuotationPage() {
  return <DynamicViewQuotationPage />;
} 