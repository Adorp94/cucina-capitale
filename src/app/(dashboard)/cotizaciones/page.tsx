...
const DynamicCotizacionesPage = dynamic(() => Promise.resolve(() => {
  ...
  return <CotizacionesPageContent />;
}), { ssr: false, loading: () => <div className="container px-4 md:px-6 py-8 md:py-10 max-w-7xl mx-auto">Cargando página...</div> });

export default function CotizacionesPage() {
  return <DynamicCotizacionesPage />;
}