  ...
  return (
    <div className="container px-4 md:px-6 py-8 md:py-10 max-w-7xl mx-auto">
      <div className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">Reportes</h1>
          <p className="text-muted-foreground">
            Visualiza estadísticas y análisis de tu negocio.
          </p>
        </div>
        ...
        <CardContent className="p-6">
          <div className="flex flex-col items-center justify-center py-10">
            ...
            <p className="text-center text-gray-600 max-w-md mb-6">
              Los reportes y análisis estarán disponibles próximamente. Estamos trabajando para ofrecerte la mejor experiencia.
            </p>
            <Button asChild>
              <Link href="/dashboard">
                Volver al Dashboard
